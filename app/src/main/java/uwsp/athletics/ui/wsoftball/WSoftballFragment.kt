...
import kotlinx.android.synthetic.main.fragment_wsoftball.*
import okhttp3.*

import uwsp.athletics.R
import uwsp.athletics.ui.wsoftball.WSoftballPagerAdapter
import java.io.IOException

class WSoftballFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wsoftball, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.wSoftballViewPager) as ViewPager
        mViewPager.adapter = WSoftballPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        wSoftballTabLayout.setupWithViewPager(mViewPager)
        fetchWSoftballScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchWSoftballScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=12&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.wSoftballDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.wSoftballUWSPScore)
                    val awayScore: TextView? = view?.findViewById(R.id.wSoftballOppScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.wSoftballOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.wSoftballUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.wSoftballOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.wSoftballUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@WSoftballFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.wSoftballUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.wSoftballOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.WSoftballRecent)
