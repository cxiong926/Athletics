...
class WSoftballSchedule : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wsoftball_schedule, container, false)
    }


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val lin: LinearLayout = view.findViewById(R.id.wSoftballSchedLinear)
        fetchWSoftballSchedule(lin)
        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchWSoftballSchedule(layout: LinearLayout) {

        val url =
            "https://athletics.uwsp.edu/services/schedule_xml_2.aspx?format=json&path=softball&take=100"
...
//                        gameDate.setTextColor(Color.parseColor("#000000"))
                        ...
                        Glide.with(this@WSoftballSchedule)
