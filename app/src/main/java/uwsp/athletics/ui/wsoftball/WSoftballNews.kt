...
class WSoftballNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wsoftball_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val mbasketlin: LinearLayout = view.findViewById(R.id.wSoftballNewsLinear)
        fetchWSoftballHomeNews(mbasketlin)

    }

    private fun fetchWSoftballHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=12&num_stories=10"
