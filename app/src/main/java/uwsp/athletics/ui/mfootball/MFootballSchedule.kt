...
class MFootballSchedule : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mfootball_schedule, container, false)
    }


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val lin: LinearLayout = view.findViewById(R.id.mFootballSchedLinear)
        fetchMFootballSchedule(lin)
        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchMFootballSchedule(layout: LinearLayout) {

        val url =
            "https://athletics.uwsp.edu/services/schedule_xml_2.aspx?format=json&path=football&take=100"
...
//                        gameDate.setTextColor(Color.parseColor("#000000"))
                        ...
                        Glide.with(this@MFootballSchedule)
