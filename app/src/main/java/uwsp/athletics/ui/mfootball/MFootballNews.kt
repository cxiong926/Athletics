...
class MFootballNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mfootball_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val mfootballlin: LinearLayout = view.findViewById(R.id.mFootballNewsLinear)
        fetchMFootballHomeNews(mfootballlin)

    }

    private fun fetchMFootballHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=8&num_stories=10"
