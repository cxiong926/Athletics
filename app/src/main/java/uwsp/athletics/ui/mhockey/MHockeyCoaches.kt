...
class MHockeyCoaches : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mhockey_coaches, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        val lin: LinearLayout = view.findViewById(R.id.mHockeyCoachesLinear)
        fetchMHockeyCoaches(lin)

        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchMHockeyCoaches(layout: LinearLayout) {

        val url = "https://athletics.uwsp.edu/services/coaches_xml.aspx?format=json&path=mhockey "
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    for (i in sidearmReturn.roster.indices) {
                        ...
                        Glide.with(this@MHockeyCoaches)
