...
import kotlinx.android.synthetic.main.fragment_mhockey.*
import okhttp3.*
import uwsp.athletics.R
import java.io.IOException

class MHockeyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mhockey, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.mHockeyViewPager) as ViewPager
        mViewPager.adapter = MHockeyPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        mHockeyTabLayout.setupWithViewPager(mViewPager)
        fetchMHockeyScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchMHockeyScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=10&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.mHockeyDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.mHockeyUWSPScore)
                    val awayScore: TextView? = view?.findViewById(R.id.mHockeyOppScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.mHockeyOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.mHockeyUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.mHockeyOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.mHockeyUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@MHockeyFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.mHockeyUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.mHockeyOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.mHockeyRecent)
