...
class MHockeyNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mhockey_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val mhockeylin: LinearLayout = view.findViewById(R.id.mHockeyNewsLinear)
        fetchMHockeyHomeNews(mhockeylin)

    }

    private fun fetchMHockeyHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=10&num_stories=10"
