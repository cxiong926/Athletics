...
import kotlinx.android.synthetic.main.fragment_cross_country.*
import okhttp3.*

import uwsp.athletics.R
import java.io.IOException

class CrossCountryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_cross_country, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.cCountryViewPager) as ViewPager
        mViewPager.adapter = CrossCountryPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        cCountryTabLayout.setupWithViewPager(mViewPager)
        fetchCCountryScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchCCountryScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=23&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.cCountryDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.cCountryOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.cCountryUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.cCountryOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.cCountryUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@CrossCountryFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.cCountryUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.cCountryOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.CCountryRecent)
