...
class TrackFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val mViewPager = view.findViewById(R.id.trackViewPager) as ViewPager
        mViewPager.adapter = TrackPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        trackTabLayout.setupWithViewPager(mViewPager)
        fetchTrackScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchTrackScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=24&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.trackDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.trackOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.trackUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.trackOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.trackUWSPPic)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.trackUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.trackOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.TrackRecent)
