...
class TrackCoaches : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_track_coaches, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        val lin: LinearLayout = view.findViewById(R.id.trackCoachesLinear)
        fetchTrackCoaches(lin)

        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchTrackCoaches(layout: LinearLayout) {

        // Request URL for  the men's baseball roster
        val url = "https://athletics.uwsp.edu/services/coaches_xml.aspx?format=json&path=track "
