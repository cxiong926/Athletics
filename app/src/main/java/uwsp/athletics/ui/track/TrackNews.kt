...
class TrackNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_track_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val mbasketlin: LinearLayout = view.findViewById(R.id.trackNewsLinear)
        fetchTrackHomeNews(mbasketlin)

    }

    private fun fetchTrackHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=24&num_stories=10"
