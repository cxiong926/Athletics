...
class TrackSchedule : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_track_schedule, container, false)
    }


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val lin: LinearLayout = view.findViewById(R.id.trackSchedLinear)
        fetchTrackSchedule(lin)
        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchTrackSchedule(layout: LinearLayout) {

        val url =
            "https://athletics.uwsp.edu/services/schedule_xml_2.aspx?format=json&path=track&take=100"
