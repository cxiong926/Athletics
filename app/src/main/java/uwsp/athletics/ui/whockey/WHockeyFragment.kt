...
class WHockeyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_whockey, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.wHockeyViewPager) as ViewPager
        mViewPager.adapter = WHockeyPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        wHockeyTabLayout.setupWithViewPager(mViewPager)
        fetchWHockeyScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchWHockeyScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=11&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.wHockeyDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.wHockeyUWSPScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.wHockeyOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.wHockeyUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.wHockeyOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.wHockeyUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@WHockeyFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.wHockeyUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.wHockeyOppIndicator)
