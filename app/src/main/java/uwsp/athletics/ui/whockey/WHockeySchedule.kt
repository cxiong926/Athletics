...
class WHockeySchedule : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_whockey_schedule, container, false)
    }


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val lin: LinearLayout = view.findViewById(R.id.wHockeySchedLinear)
        fetchWHockeySchedule(lin)
        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchWHockeySchedule(layout: LinearLayout) {

        val url =
            "https://athletics.uwsp.edu/services/schedule_xml_2.aspx?format=json&path=whockey&take=100"
...
//                            infoLinearLayout.setBackgroundResource(R.drawable.border)
                        ...
                        Glide.with(this@WHockeySchedule)
