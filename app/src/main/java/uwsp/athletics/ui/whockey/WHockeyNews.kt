...
class WHockeyNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_whockey_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val whockeylin: LinearLayout = view.findViewById(R.id.wHockeyNewsLinear)
        fetchWHockeyHomeNews(whockeylin)
    }

    private fun fetchWHockeyHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=11&num_stories=10"
