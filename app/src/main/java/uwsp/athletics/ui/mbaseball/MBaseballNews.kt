...
class MBaseballNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mbaseball_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val mbaselin: LinearLayout = view.findViewById(R.id.mBaseNewsLinear)
        fetchMBaseHomeNews(mbaselin)

    }

    private fun fetchMBaseHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=3&num_stories=10"
