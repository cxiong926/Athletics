...
import kotlinx.android.synthetic.main.fragment_mbaseball.*
import okhttp3.*
import uwsp.athletics.R
import java.io.IOException


class MBaseballFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mbaseball, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.mBaseballViewPager) as ViewPager
        mViewPager.adapter = MBaseballPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        mBaseballTabLayout.setupWithViewPager(mViewPager)
        fetchMBaseScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchMBaseScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=3&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.mBaseDate)
//                    val time: TextView? = view?.findViewById(R.id.mBaseTime)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.mBaseUWSPScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.mBaseOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.mBaseUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.mBaseOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.mBaseUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@MBaseballFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.mBaseUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.mBaseOppIndicator)
