 ...
 */
class MBaseballAthletes : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mbaseball_athletes, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

//        Loads the donor website after view created
//        val imageView: WebView = getView()!!.findViewById<View>(R.id.rosterWebview) as WebView
////        imageView.setJavaScriptEnabled(true)
//        imageView.settings.javaScriptEnabled = true
//        imageView.loadUrl("https://athletics.uwsp.edu/sports/baseball/roster")

        val lin: LinearLayout = view.findViewById(R.id.mBaseAthletesLinear)
        fetchMBaseRoster(lin)

        super.onViewCreated(view, savedInstanceState)
    }

    // Function to fetch and create the roster
    private fun fetchMBaseRoster(layout: LinearLayout) {

        // Request URL for  the men's baseball roster
        val url = "https://athletics.uwsp.edu/services/roster_xml.aspx?format=json&path=baseball"
...
//                    layout.addView(title)
                    ...
                    for (i in sidearmReturn.roster.indices) {
                        ...
                        Glide.with(this@MBaseballAthletes)
                        ...
                        tv.append("Weight: " + sidearmReturn.roster[i].playerinfo.weight + "lbs" + "\n")
