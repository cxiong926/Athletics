...
class WWrestlingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wwrestling, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.wWrestlingViewPager) as ViewPager
        mViewPager.adapter = WWrestlingPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        wWrestlingTabLayout.setupWithViewPager(mViewPager)
        fetchWWrestlingScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchWWrestlingScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=25&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.wWrestlingDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.wWrestlingUWSPScore)
                    val awayScore: TextView? = view?.findViewById(R.id.wWrestlingOppScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.wWrestlingOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.wWrestlingUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.wWrestlingOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.wWrestlingUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@WWrestlingFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.wWrestlingUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.wWrestlingOppIndicator)
