...
class WWrestlingCoaches : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wwrestling_coaches, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        val lin: LinearLayout = view.findViewById(R.id.wWrestlingCoachesLinear)
        fetchWWrestlingCoaches(lin)
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    for (i in sidearmReturn.roster.indices) {
                        ...
                        Glide.with(this@WWrestlingCoaches)
