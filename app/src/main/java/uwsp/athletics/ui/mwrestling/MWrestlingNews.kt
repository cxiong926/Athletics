...
class MWrestlingNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mwrestling_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val mbasketlin: LinearLayout = view.findViewById(R.id.mWrestlingNewsLinear)
        fetchMWrestlingHomeNews(mbasketlin)

    }

    private fun fetchMWrestlingHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=19&num_stories=19"
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    for (i in newsReturn.indices) {
                        ...
                        Glide.with(this@MWrestlingNews)
