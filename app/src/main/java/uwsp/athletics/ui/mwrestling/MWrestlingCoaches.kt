...
class MWrestlingCoaches : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mwrestling_coaches, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        val lin: LinearLayout = view.findViewById(R.id.mWrestlingCoachesLinear)
        fetchMWrestlingCoaches(lin)

        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchMWrestlingCoaches(layout: LinearLayout) {

        val url = "https://athletics.uwsp.edu/services/coaches_xml.aspx?format=json&path=wrestling "
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    for (i in sidearmReturn.roster.indices) {
                        ...
                        Glide.with(this@MWrestlingCoaches)
