...
class MWrestlingSchedule : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mwrestling_schedule, container, false)
    }


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val lin: LinearLayout = view.findViewById(R.id.mWrestlingSchedLinear)
        fetchMWrestlingSchedule(lin)
        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchMWrestlingSchedule(layout: LinearLayout) {

        val url =
            "https://athletics.uwsp.edu/services/schedule_xml_2.aspx?format=json&path=wrestling&take=100"
...
//                        gameDate.setTextColor(Color.parseColor("#000000"))
                        ...
                        Glide.with(this@MWrestlingSchedule)
