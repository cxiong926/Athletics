...
import kotlinx.android.synthetic.main.fragment_wtennis.*
import okhttp3.*

import uwsp.athletics.R
import uwsp.athletics.ui.wtennis.WTennisPagerAdapter
import java.io.IOException

class WTennisFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wtennis, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.wTennisViewPager) as ViewPager
        mViewPager.adapter = WTennisPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        wTennisTabLayout.setupWithViewPager(mViewPager)
        fetchWTennisScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchWTennisScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=16&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.wTennisDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.wTennisOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.wTennisUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.wTennisOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.wTennisUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@WTennisFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.wTennisUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.wTennisOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.WTennisRecent)
