package uwsp.athletics.ui.mbasketball
...
import kotlinx.android.synthetic.main.fragment_mbasketball.*
import okhttp3.*
import uwsp.athletics.R
import java.io.IOException

class MBasketballFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mbasketball, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.mBasketballViewPager) as ViewPager
        mViewPager.adapter = MBasketballPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        mBasketballTabLayout.setupWithViewPager(mViewPager)
        fetchMBasketballScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchMBasketballScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=4&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.mBasketballDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.mBasketballUWSPScore)
                    val awayScore: TextView? = view?.findViewById(R.id.mBasketballOppScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.mBasketballOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.mBasketballUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.mBasketballOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.mBasketballUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@MBasketballFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.mBasketballUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.mBasketballOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.MBasketballRecent)
