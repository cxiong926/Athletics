...
class WGolfSchedule : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wgolf_schedule, container, false)
    }


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val lin: LinearLayout = view.findViewById(R.id.wGolfSchedLinear)
        fetchWGolfSchedule(lin)
        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchWGolfSchedule(layout: LinearLayout) {

        val url =
            "https://athletics.uwsp.edu/services/schedule_xml_2.aspx?format=json&path=wgolf&take=100"
