...
class WGolfCoaches : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wgolf_coaches, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        val lin: LinearLayout = view.findViewById(R.id.wGolfCoachesLinear)
        fetchWGolfCoaches(lin)

        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchWGolfCoaches(layout: LinearLayout) {

        // Request URL for  the men's baseball roster
        val url = "https://athletics.uwsp.edu/services/coaches_xml.aspx?format=json&path=wgolf "
