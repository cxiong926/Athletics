...
import kotlinx.android.synthetic.main.fragment_wgolf.*
import okhttp3.*

import uwsp.athletics.R
import uwsp.athletics.ui.wgolf.WGolfPagerAdapter
import java.io.IOException

class WGolfFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wgolf, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.wGolfViewPager) as ViewPager
        mViewPager.adapter = WGolfPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        wGolfTabLayout.setupWithViewPager(mViewPager)
        fetchWGolfScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchWGolfScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=9&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.wGolfDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.wGolfOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.wGolfUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.wGolfOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.wGolfUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@WGolfFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.wGolfUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.wGolfOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.WGolfRecent)
