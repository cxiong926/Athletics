...
class WGolfNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wgolf_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val wgolflin: LinearLayout = view.findViewById(R.id.wGolfNewsLinear)
        fetchWGolfHomeNews(wgolflin)

    }

    private fun fetchWGolfHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=9&num_stories=10"
