...
class WSoccerNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wsoccer_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val wsoccerlin: LinearLayout = view.findViewById(R.id.wSoccerNewsLinear)
        fetchWSoccerHomeNews(wsoccerlin)

    }

    private fun fetchWSoccerHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=20&num_stories=10"
