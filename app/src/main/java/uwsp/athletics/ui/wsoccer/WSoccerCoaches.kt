...
class WSoccerCoaches : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wsoccer_coaches, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        val lin: LinearLayout = view.findViewById(R.id.wSoccerCoachesLinear)
        fetchWSoccerCoaches(lin)

        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchWSoccerCoaches(layout: LinearLayout) {

        // Request URL for  the men's baseball roster
        val url = "https://athletics.uwsp.edu/services/coaches_xml.aspx?format=json&path=wsoc"
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    for (i in sidearmReturn.roster.indices) {
                        ...
                        Glide.with(this@WSoccerCoaches)
