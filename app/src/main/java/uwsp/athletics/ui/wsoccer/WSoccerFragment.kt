...
import kotlinx.android.synthetic.main.fragment_wsoccer.*
import okhttp3.*

import uwsp.athletics.R
import uwsp.athletics.ui.wsoccer.WSoccerPagerAdapter
import java.io.IOException

class WSoccerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wsoccer, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.wSoccerViewPager) as ViewPager
        mViewPager.adapter = WSoccerPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        wSoccerTabLayout.setupWithViewPager(mViewPager)
        fetchWSoccerScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchWSoccerScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=20&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.wSoccerDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.wSoccerUWSPScore)
                    val awayScore: TextView? = view?.findViewById(R.id.wSoccerOppScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.wSoccerOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.wSoccerUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.wSoccerOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.wSoccerUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@WSoccerFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.wSoccerUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.wSoccerOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.WSoccerRecent)
