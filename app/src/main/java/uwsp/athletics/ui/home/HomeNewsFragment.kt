...
class HomeNewsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val lin: LinearLayout = view.findViewById(R.id.homeNewsLinear)
        fetchHomeNews(lin)

    }

    // add parameters: url, linear layout, this@fragment, number of items?
    private fun fetchHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?num_stories=10"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                val newsReturn = gson.fromJson(body, Array<NewsArray>::class.java)
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    for (i in newsReturn.indices) {
                        ...
                        date.textSize = 14.0f
                        // #8A000000 use this color if the date is too light
                        ...
                        Glide.with(this@HomeNewsFragment)
