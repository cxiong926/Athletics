...
class SwimNews : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_swim_news, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val mbasketlin: LinearLayout = view.findViewById(R.id.swimNewsLinear)
        fetchswimHomeNews(mbasketlin)

    }

    private fun fetchswimHomeNews(layout: LinearLayout) {

        // Hardcoded url for 10 general athletics stories
        val url = "https://athletics.uwsp.edu/services/get_stories.ashx?sport_id=21&num_stories=10"
