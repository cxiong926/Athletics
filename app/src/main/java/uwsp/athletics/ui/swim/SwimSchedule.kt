...
class SwimSchedule : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_swim_schedule, container, false)
    }


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val lin: LinearLayout = view.findViewById(R.id.swimSchedLinear)
        fetchSwimSchedule(lin)
        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchSwimSchedule(layout: LinearLayout) {

        val url =
            "https://athletics.uwsp.edu/services/schedule_xml_2.aspx?format=json&path=swim&take=100"
