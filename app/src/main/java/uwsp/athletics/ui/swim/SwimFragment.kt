...
class SwimFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val mViewPager = view.findViewById(R.id.swimViewPager) as ViewPager
        mViewPager.adapter = SwimPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        swimTabLayout.setupWithViewPager(mViewPager)
        fetchswimScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchswimScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=21&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.swimDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.swimUWSPScore)
                    val awayScore: TextView? = view?.findViewById(R.id.swimOppScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.swimOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.swimUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.swimOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.swimUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@SwimFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.swimUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.swimOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.swimRecent)
