...
class WBasketballAthletes : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wbasketball_athletes, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {


        val lin: LinearLayout = view.findViewById(R.id.wBasketballAthletesLinear)
        fetchWBasketballRoster(lin)

        super.onViewCreated(view, savedInstanceState)
    }

    // Function to fetch and create the roster
    private fun fetchWBasketballRoster(layout: LinearLayout) {

        // Request URL for  the men's baseball roster
        val url = "https://athletics.uwsp.edu/services/roster_xml.aspx?format=json&path=wbball"
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    for (i in sidearmReturn.roster.indices) {
                        ...
                        Glide.with(this@WBasketballAthletes)
