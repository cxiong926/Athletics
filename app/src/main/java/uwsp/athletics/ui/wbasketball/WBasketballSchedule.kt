...
class WBasketballSchedule : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wbasketball_schedule, container, false)
    }


    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val lin: LinearLayout = view.findViewById(R.id.wBasketballSchedLinear)
        fetchWBasketballSchedule(lin)
        super.onViewCreated(view, savedInstanceState)
    }

    private fun fetchWBasketballSchedule(layout: LinearLayout) {

        val url =
            "https://athletics.uwsp.edu/services/schedule_xml_2.aspx?format=json&path=wbball&take=100"
...
//                        gameDate.setTextColor(Color.parseColor("#000000"))
                        ...
                        Glide.with(this@WBasketballSchedule)
