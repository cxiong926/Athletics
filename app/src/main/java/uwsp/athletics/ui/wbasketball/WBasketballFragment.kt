...
class WBasketballFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wbasketball, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.wBasketballViewPager) as ViewPager
        mViewPager.adapter = WBasketballPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        wBasketballTabLayout.setupWithViewPager(mViewPager)
        fetchWBasketballScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchWBasketballScore() {
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.wBasketballDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.wBasketballUWSPScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.wBasketballOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.wBasketballUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.wBasketballOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.wBasketballUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@WBasketballFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.wBasketballUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.wBasketballOppIndicator)
