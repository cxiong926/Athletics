package uwsp.athletics.ui.wvolleyball
...
import kotlinx.android.synthetic.main.fragment_wvolleyball.*
import okhttp3.*

import uwsp.athletics.R
import uwsp.athletics.ui.wvolleyball.WVolleyballPagerAdapter
import java.io.IOException

class WVolleyballFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_wvolleyball, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {

        // Adds the viewpager to the fragment
        val mViewPager = view.findViewById(R.id.wVolleyballViewPager) as ViewPager
        mViewPager.adapter = WVolleyballPagerAdapter(childFragmentManager)

        //Adds the tab to the fragment
        wVolleyballTabLayout.setupWithViewPager(mViewPager)
        fetchWVolleyballScore()
        super.onViewCreated(view, savedInstanceState)

    }

    private fun fetchWVolleyballScore() {

        // Request URL for most recent game
        val url =
            "https://athletics.uwsp.edu/services/gameday.ashx?type=get-schedule-games&sport_id=13&take=1"
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                activity?.runOnUiThread(java.lang.Runnable {
                    ...
                    val date: TextView? = view?.findViewById(R.id.wVolleyballDate)
...
//                    time?.text = scoreReturn[0].time
                    ...
                    val homeScore: TextView? = view?.findViewById(R.id.wVolleyballUWSPScore)
                    val awayScore: TextView? = view?.findViewById(R.id.wVolleyballOppScore)
                    ...
                    val awayTeam: TextView? = view?.findViewById(R.id.wVolleyballOppTeam)
                    val homeTeam: TextView? = view?.findViewById(R.id.wVolleyballUWSPTeam)
                    ...
                    val awayTeamPic: ImageView = view!!.findViewById(R.id.wVolleyballOppPic)
                    val homeTeamPic: ImageView = view!!.findViewById(R.id.wVolleyballUWSPPic)

                    // Loads the away team's image from the returned URL
                    Glide.with(this@WVolleyballFragment)
                    ...
                    val uwspIndicator: TextView? = view?.findViewById(R.id.wVolleyballUWSPIndicator)
                    val oppIndicator: TextView? = view?.findViewById(R.id.wVolleyballOppIndicator)
                    ...
                    val recentUpcoming: TextView? = view?.findViewById(R.id.WVolleyballRecent)
